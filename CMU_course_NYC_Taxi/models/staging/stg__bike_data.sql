...
select
	...
	coalesce("start station latitude", start_lat) as start_lat,
	coalesce("start station longitude", start_lng) as start_lng, 
	coalesce("end station id", end_station_id) as end_station_id,  
	coalesce("end station name", end_station_name) as end_station_name,
	coalesce("end station latitude", end_lat) as end_lat,
	coalesce("end station longitude", end_lng) as end_lng,
	filename
from renamed